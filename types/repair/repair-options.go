...
const LINE_CLOSENESS_PERCENT uint8 = 4   // NOTE: From ANY point in the edge - 0-255%, 100% is the full length of the edge
const VERTEX_CLOSENESS_PERCENT uint8 = 4 // NOTE: From the BORDER of the vertex - 0-255%, 100% = length of edge of the vertex
